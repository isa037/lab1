...
#  Created on Sat Oct 24 11:38:58 2020                
#                                                     
#######################################################
...
selectInst FIR_y3k2_2_MULT1_mult_19_U196
deselectAll
saveDesign full_FIR.enc
saveDesign full_FIR.enc
fit
getDrawView
setDrawView fplan
win
dumpToGIF ./ss_ss_unfolded_chip.fplan.gif
getDrawView
setDrawView amoeba
win
dumpToGIF ./ss_ss_unfolded_chip.amoeba.gif
getDrawView
setDrawView place
win
dumpToGIF ./ss_ss_unfolded_chip.place.gif
...
timeDesign -postRoute -pathReports -slackReports -numPaths 50 -prefix full_FIR_postRoute -outDir timingReports
redirect -quiet {set honorDomain [getAnalysisMode -honorClockDomains]} > /dev/null
...
report_power -rail_analysis_format VS -outfile .//full_FIR.rpt
report_power -outfile power_report_chip_placeandrouted.txt -clock_network all -hierarchy all -cell_type all -sort { total }
